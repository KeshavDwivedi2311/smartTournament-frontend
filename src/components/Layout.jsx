      ...
      <header className="bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex items-center justify-between">
            <Link to="/app" className="flex items-center gap-2 hover:opacity-90 transition-opacity">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                to="/"
                className="text-sm sm:text-base px-3 py-2 rounded-md hover:bg-white/10 transition-colors opacity-70"
              >
                Home
              </Link>
            </div>
